 ...
 * access to a DB2 instance. Love to get 1-2 hours of access to an database to
 * test/tweak this. Undoubtably is it wrong. Please contact us if you'd like to
...
public class Db2DatabaseType extends BaseDatabaseType
{
	...
	private final static String DRIVER_CLASS_NAME = "COM.ibm.db2os390.sqlj.jdbc.DB2SQLJDriver";
